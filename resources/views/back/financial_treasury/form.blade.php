                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    <div class="row row-xs">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div>
                                <input type="text" class="form-control dataInput" placeholder="اسم الخزينة" id="name" name="name" data-autofocus>
                            </div>
                            <bold class="text-danger" id="errors-name" style="display: none;"></bold>
                        </div>                        

                        <div class="col-lg-4" id="moneyFirstDurationSection">
                            <label for="moneyFirstDuration">رصيد أول المدة</label>
                            {{--<i class="fas fa-star require_input"></i>--}}
                            <div>
                                <input type="text" class="form-control dataInput focused" placeholder="رصيد أول المدة" id="moneyFirstDuration" name="moneyFirstDuration" value="0">
                            </div>
                            <bold class="text-danger" id="errors-moneyFirstDuration" style="display: none;"></bold>
                        </div>                        
                        ...
                        <div class="col-lg-6">
                          <label for="userOne">أمين الخزنة</label>
                          <div>    
                            <input type="text" class="form-control dataInput" placeholder="أمين الخزنة" id="userOne" name="userOne">
                          </div>
                          <bold class="text-danger" id="errors-userOne" style="display: none;"></bold>
                        </div>     
