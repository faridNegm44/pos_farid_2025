...
<!-- Mirrored from codeigniter.spruko.com/valex/rtl/public/pages/signin by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jan 2022 09:50:17 GMT -->
...
<head>
		...
		<!-- Bootstrap css-->
		<link href="{{ url('back') }}/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet"/>

		<!-- Icons css -->
		<link href="{{ url('back') }}/assets/css-rtl/icons.css" rel="stylesheet">

        <!-- P-scroll bar css remove in final -->
		<link href="{{ url('back') }}/assets/plugins/perfect-scrollbar/p-scrollbar.css" rel="stylesheet" />
	...
	<body class="main-body">
					...
					<div class="row">
						...
						<div class="predefined_styles">
							<div class="swichermainleft">
								...
								<div class="pl-3 pr-3">
									<a href="{{ url('back') }}/../pages/horizontal-light.html" class="btn btn-danger btn-block mt-0">Horizontal</a>
									<a href="{{ url('back') }}/../pages/icon-light.html" class="btn btn-info btn-block">Left-menu</a>
								</div>
							</div>
							<div class="swichermainleft">
								<h4>Skin Modes</h4>
								<div class="pl-0 pr-0">
									<a class="wscolorcode blackborder nav-hor navstyle1" href="{{ url('back') }}/../pages/icon-light.html">
										Light-theme
									</a>
									<a class="wscolorcode blackborder nav-hor navstyle1" href="{{ url('back') }}/../pages/icon-dark.html">
										Dark-theme
									</a>
								</div>
							</div>
		...
		<div id="global-loader">
			<img src="{{ url('back') }}/assets/img/loader.svg" class="loader-img" alt="Loader">
		</div>
		<!-- /Loader -->
						...
						<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
							<div class="row wd-100p mx-auto text-center">
								<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
									<img src="{{ url('back') }}/assets/img/media/login.png" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
								</div>
							</div>
						</div>
						<!-- The content half -->
									...
									<div class="row">
										<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
											<div class="card-sigin">
												<div class="mb-5 d-flex"> <a href="index.html"><img src="{{ url('back') }}/assets/img/brand/favicon.png" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 mr-1 mr-0 my-auto tx-28">Va<span>le</span>x</h1></div>
												<div class="card-sigin">
		...
		<!-- Bootstrap js -->
        <script src="{{ url('back') }}/assets/plugins/bootstrap/js/popper.min.js"></script>
		...
		<script src="{{ url('back') }}/assets/plugins/perfect-scrollbar/perfect-scrollbar.min-rtl.js"></script>
		<script src="{{ url('back') }}/assets/plugins/perfect-scrollbar/p-scroll-rtl.js"></script>

		<!-- eva-icons js -->
		<script src="{{ url('back') }}/assets/js/eva-icons.min.js"></script>
