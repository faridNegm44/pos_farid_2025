        ...
        <div class="modal-body">
            <form class="" id="form" enctype="multipart/form-data">
                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                  <div class="col-md-12">
                      <label for="client_supplier">الجهة</label>
                      <i class="fas fa-star require_input"></i>
                      <div>
                          <select name="client_supplier" class="client_supplier form-control" id="client_supplier">
                            <option value="" selected disabled>اختر الجهة</option>                              
                            <option value="عميل">عميل</option>                              
                            <option value="مورد">مورد</option>                              
                          </select>
                      </div>
                      <bold class="text-danger" id="errors-client_supplier" style="display: none;"></bold>
                  </div> 

                  <div class="row row-xs" id="hide_section" style="display: none;">
                    <div class="col-lg-4 col-12">
                      <label for="client_supplier_id">أشخاص الجهة</label>
                      <div>
                          <select name="client_supplier_id" class="client_supplier_id" id="client_supplier_id">
                            
                          </select>
                      </div>
                      <bold class="text-danger" id="errors-client_supplier_id	" style="display: none;"></bold>
                    </div>  
