<script>
    ...
    let company_name = $(this).attr("company_name");
    ...
    alertify.confirm(
        ...
        `<span class="text-center">
            ...
            <strong class="d-block">${company_name}</strong>
        </span>`, 
    function(){
        $.ajax({
              ...
              success: function(res){
                if(res.success_delete){
                    ...
                    alertify.success(`تم حذف الشركة بنجاح`);
                }

                if(res.cannot_delete){
                    alertify.set('notifier','position', 'top-center');
                    alertify.set('notifier','delay', 6);
                    alertify.warning(`خطأ: لايمكن حذف الشركة لأنها مسجلة لأصناف بالفعل.`);
                }
