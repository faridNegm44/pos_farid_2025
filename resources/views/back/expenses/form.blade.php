            ...
            <form class="" id="form" enctype="multipart/form-data">
                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    <div class="row row-xs">
                        ...
                        <div class="col-lg-4">
                            <label for="amount">مبلغ المصروف</label>
                            <i class="fas fa-star require_input"></i>
                            <div>
                                <input type="text" class="form-control dataInput" placeholder="مبلغ المصروف" id="amount" name="amount" value="0">
                            </div>
                            <bold class="text-danger" id="errors-amount" style="display: none;"></bold>
                        </div>                        

                        <div class="col-lg-8">
                            <label for="title">وصف المصروف</label>
                            <i class="fas fa-star require_input"></i>
                            <div>
                                <input type="text" class="form-control dataInput" placeholder="وصف المصروف" id="title" name="title">
                            </div>
