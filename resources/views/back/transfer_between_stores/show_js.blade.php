    ...
    $(document).on("click" , "#example1 tr .show" ,function(){
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                $(`#exampleModalCenterShow .modal-body #num_order_treasure_from span`).text(res.find[0].transfer_from_name);
                $(`#exampleModalCenterShow .modal-body #value_treasure_from span`).text(res.find[0].money);
                
                $(`#exampleModalCenterShow .modal-body #num_order_treasure_to span`).text(res.find[1].transfer_to_name);
