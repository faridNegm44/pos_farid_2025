					...
					<div class="row">
						...
						<div class="predefined_styles">
							<div class="swichermainleft">
								...
								<div class="pl-3 pr-3">
									<a href="../../pages/horizontal-light.html" class="btn btn-danger btn-block mt-0">Horizontal</a>
									<a href="../../pages/icon-light.html" class="btn btn-info btn-block">Left-menu</a>
								</div>
							</div>
							<div class="swichermainleft">
								<h4>Skin Modes</h4>
								<div class="pl-0 pr-0">
									<a class="wscolorcode blackborder nav-hor navstyle1" href="../../pages/icon-light.html">
										Light-theme
									</a>
									<a class="wscolorcode blackborder nav-hor navstyle1" href="../../pages/icon-dark.html">
										Dark-theme
									</a>
								</div>
							</div>
