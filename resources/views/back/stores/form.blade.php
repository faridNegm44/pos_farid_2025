                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    <div class="row row-xs">
                        ...
                        <div class="col-md-12">
                            ...
                            <div>
                                <input type="text" class="form-control dataInput" placeholder="اسم المخزن" id="name" name="name" data-autofocus>
                            </div>
                        ...
                        <div class="col-md-12">
                          ...
                          <div>
                              <input type="text" class="form-control dataInput" placeholder="ملاحظات" id="notes" name="notes" data-autofocus>
                          </div>
