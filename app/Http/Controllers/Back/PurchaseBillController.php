    ...
    public function store(Request $request)
    {
        if (request()->ajax()){
            ...
            $this->validate($request, [
                ...
                'product_new_qty' => 'كميات المنتجات',
                'product_new_qty.*' => 'الكمية لكل منتج',
            ...
            // بداية حساب نوع الخصم قيمه ام نسبة ام غير موجود وتوزيع الخصم بالتساوي علي اصناف الفاتوره
                ...
                foreach( request('prod_name')  as $index => $product_id ){
                    ...
                    $totalBillBeforeDiscount += ($quantity * $purchasePrice);                
                }
            ...
            DB::transaction(function() use ($totalBillBeforeDiscount, $totalBillAfterDiscount){
