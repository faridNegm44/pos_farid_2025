...
// end => حساب الربحيه اليوم - إجمالي المبيعات اليوم
...
// start count totalSuppliersDebts => حساب اجمالي مديونيات الموردين
function totalSuppliersDebts(){
    return DB::table('treasury_bill_dets as t1')
                        ->join('clients_and_suppliers', 'clients_and_suppliers.id', 't1.client_supplier_id')
                        ->select('t1.remaining_money')
...
// end count totalSuppliersDebts => حساب اجمالي مديونيات الموردين
